...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		availabilityRoute := apiRouter.Group("/channel/availability")
		availabilityRoute.GET("", middleware.UserAuth(), controller.GetChannelAvailability)
		availabilityRoute.POST("/test", middleware.AdminAuth(), controller.TestChannelAvailability)
		availabilityRoute.GET("/test/status", middleware.AdminAuth(), controller.GetChannelAvailabilityTestStatus)
