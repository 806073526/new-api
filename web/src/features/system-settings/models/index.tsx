...
const defaultModelSettings: ModelSettings = {
  ...
  'channel_model_health_setting.enabled': false,
  'channel_model_health_setting.failure_threshold': 3,
  'channel_model_health_setting.failure_window_seconds': 60,
  'channel_model_health_setting.first_response_timeout_seconds': 0,
  'channel_model_health_setting.cooldown_seconds': 60,
  'channel_model_health_setting.max_cooldown_seconds': 1800,
  'channel_model_health_setting.half_open_lease_seconds': 30,
  'channel_model_health_setting.active_probe_interval_seconds': 0,
